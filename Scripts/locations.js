        ...
        var pageViewModel = function () {
            var locations = ko.observableArray(),
                ...
                saveLocation = function () {
                    var locationUrl = "../api/location/save";
                    ajaxHelper(locationUrl, 'POST',selectedLocation()).done(function (response) {
                        ...
                        if (response) {
                            ...
                            Messenger().post({
                                message: "WTF! Something's not right ",
                                type: 'error',
                                showCloseButton: false
                            });
                        }
            ...
            function getLocations() {
                ...
                ajaxHelper(locationUrl, 'GET').done(function (data) {
                    locations(data);
                    initDataTables();
                });
            }
